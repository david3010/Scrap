...
namespace Aplicacion_de_SCRAP.Controllers
{
    public class LinesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "LineID,IIdLinea,LineName,Tipo")] Line line)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "LineID,IIdLinea,LineName,Tipo")] Line line)
        {
            if (ModelState.IsValid)
            {
